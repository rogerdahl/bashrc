...
# 'info' is used by the GNU Info doc reader, usually used for man pages.
...
# Create a line to separate two sections of text
# Use with the 'p*' commands. E.g.. 'pinfo sep'
sep() {
  local caret_col="$(get_caret_col)"
  echo $caret_col
  local i=$((COLUMNS - caret_col))
